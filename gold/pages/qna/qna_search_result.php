        ...
        <div class="qnaBoxes deweBoxes">
          <div class="qnaTable">
            <ul class="qnaList">
              ...
              <?php
                $search_select=$_POST['searchSlect'];
                ...
                if(!$search_result_num){
                  ...
                  while($search_select_row=mysqli_fetch_array($search_result)){
                    $result_num=$search_select_row['GOLD_QNA_num'];
                    $result_id=$search_select_row['GOLD_QNA_id'];
                    $result_tit=$search_select_row['GOLD_QNA_tit'];
                    $result_reg=$search_select_row['GOLD_QNA_reg'];
                    $result_hit=$search_select_row['GOLD_QNA_hit'];
               ?>
