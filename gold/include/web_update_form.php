  ...
  <form action="/gold/php_process/pages/web_update.php?num=<?=$web_num?>" method="post" name="web_form" enctype="multipart/form-data">
    <div class="titleSer clear">
      <p class="title_input">
        ...
        <input type="text" value="<?=$web_result_tit?>" id="title" name="web_title">
      </p>
      <p class="serial_input">
        <label for="title">SerialNo.</label>
        <input type="text" value="<?=$web_result_ser?>" id="serial" name="web_serial">
      </p>
      <p class="client_input">
        <label for="title">Client</label>
        <input type="text" value="<?=$web_result_cli?>" id="client" name="web_client"></p>
      <p class="domain_input">
        <label for="title">Domain</label>
        <input type="text" value="<?=$web_result_dom?>" id="domain" name="web_domain"></p>
    ...
    <div class="uploadImgs clear">
      <div class="uploadBox img1">
        <div class="inputControll">
          <input class="uploadName" value="<?=$web_result_img?>">
      ...
      <div class="uploadBox img2">
        <div class="inputControll">
          <input class="uploadName" value="<?=$web_result_mimg?>">
      ...
      <div class="uploadBox img3">
        <div class="inputControll">
          <input class="uploadName" value="<?=$web_result_thumb?>">
