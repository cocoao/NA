  ...
  <form action="/gold/php_process/pages/app_update.php?num=<?=$app_num?>" method="post" name="app_form" enctype="multipart/form-data">
    <div class="titleSer clear">
      <p class="title_input">
        ...
        <input type="text" value="<?=$app_result_tit?>" id="title" name="app_title">
      </p>
      <p class="serial_input">
        <label for="title">SerialNo.</label>
        <input type="text" value="<?=$app_result_ser?>" id="serial" name="app_serial">
      </p>
      <p class="client_input">
        <label for="title">Client</label>
        <input type="text" value="<?=$app_result_cli?>" id="client" name="app_client"></p>
    ...
    <div class="uploadImgs clear">
      <div class="uploadBox appImg img1">
        <div class="inputControll">
          <input class="uploadName" value="<?=$app_result_img?>">
      ...
      <div class="uploadBox appImg img2">
        <div class="inputControll">
          <input class="uploadName" value="<?=$app_result_thumb?>">
        ...
        <div class="thumb_box imgWrap">
          <img id="thumb" src='/gold/data/app_page/app_thumb/<?=$app_result_thumb?>'>
        </div>
      </div>
    </div><!-- end of image upload box -->
  </form>
</div><!-- end of app input form -->
<div class="btns">
