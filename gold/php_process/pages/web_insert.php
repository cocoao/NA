<?php
  ...
  $sql = "insert into gold_web(GOLD_WEB_tit,GOLD_WEB_ser,GOLD_WEB_des,GOLD_WEB_img,GOLD_WEB_mimg,GOLD_WEB_thumb,GOLD_WEB_cli,GOLD_WEB_reg,GOLD_WEB_dom) values('$web_title','$web_serial','$web_desc','$main_name','$mobile_name','$thumbnail_name','$web_client','$regist_day','$web_domain')";
