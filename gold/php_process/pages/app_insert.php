<?php
  ...
  if($thumbnail_name && !$thumbnail_error){
    ...
    $sql = "insert into gold_app(GOLD_APP_tit,GOLD_APP_ser,GOLD_APP_des,GOLD_APP_img,GOLD_APP_thumb,GOLD_APP_cli,GOLD_APP_reg) values('$app_title','$app_serial','$app_desc','$main_name','$thumbnail_name','$app_client','$regist_day')";
