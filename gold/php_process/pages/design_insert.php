<?php
    ...
    $sql = "insert into gold_de(GOLD_DE_tit,GOLD_DE_ser,GOLD_DE_des,GOLD_DE_img1,GOLD_DE_img2,GOLD_DE_thumb,GOLD_DE_cli,GOLD_DE_reg) values('$design_title','$design_serial','$design_desc','$main_name','$sub_name','$thumbnail_name','$design_client','$regist_day')";
